...
# Check and install efficientnet if needed
try:
    from efficientnet.tfkeras import EfficientNetB0
    print("efficientnet package found")
except ImportError:
    print("efficientnet package not found. Installing...")
    import subprocess
    import sys
    subprocess.check_call([sys.executable, "-m", "pip", "install", "efficientnet"])
    from efficientnet.tfkeras import EfficientNetB0
...
try:
    ...
    print("Loading EfficientNetB0 base model with ImageNet weights...")
...
# Setup ImageDataGenerator with light augmentation (same as MobileNetV2)
print("\n" + "="*60)
...
# Save model to ../models/efficientnetb0_model.h5
print("\n" + "="*60)
print("Saving model...")
print("="*60)

try:
    # Save to ../models/efficientnetb0_model.h5 as specified
    ...
    # Also save to local models directory for backup
    local_models_dir = "models"
    os.makedirs(local_models_dir, exist_ok=True)
    local_model_path = os.path.join(local_models_dir, "efficientnetb0_model.h5")
    
    model.save(model_path)
    model.save(local_model_path)
    print(f"Model saved successfully to: {model_path}")
    print(f"Model also saved to: {local_model_path}")
...
try:
    ...
    plt.title('EfficientNetB0 Model Accuracy', fontsize=14, fontweight='bold')
    ...
    plt.title('EfficientNetB0 Model Loss', fontsize=14, fontweight='bold')
    plt.xlabel('Epoch', fontsize=12)
    ...
    print("Training curves saved to efficientnetb0_training_curves.png")
    plt.show()
...
print("\n" + "="*60)
print("EfficientNetB0 Transfer Learning Training Completed Successfully!")
print("="*60)
print(f"Model saved to: {model_path}")
print(f"Training curves saved to: efficientnetb0_training_curves.png")
print("="*60)
